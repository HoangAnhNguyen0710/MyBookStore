 ...
 * 
 * @export
 * @interface ListingCategoriesResponseDto
 */
export interface ListingCategoriesResponseDto {
    /**
     * 
     * @type {Array<CategoryItem>}
     * @memberof ListingCategoriesResponseDto
     */
...
export const CategoryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        categoriesControllerGetAll: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CategoryApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async categoriesControllerBulkCreate(body: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CategoryApi.categoriesControllerBulkCreate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async categoriesControllerGetAll(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.categoriesControllerGetAll(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CategoryApi.categoriesControllerGetAll']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const CategoryApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        categoriesControllerGetAll(options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.categoriesControllerGetAll(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class CategoryApi extends BaseAPI {
    ...
    public categoriesControllerBulkCreate(body: object, options?: RawAxiosRequestConfig) {
        return CategoryApiFp(this.configuration).categoriesControllerBulkCreate(body, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CategoryApi
     */
    public categoriesControllerGetAll(options?: RawAxiosRequestConfig) {
        return CategoryApiFp(this.configuration).categoriesControllerGetAll(options).then((request) => request(this.axios, this.basePath));
    }
}
